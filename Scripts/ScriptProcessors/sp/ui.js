...
const var grs2 = Synth.getEffect("gran");
...
const var grs3 = Synth.getEffect("gran");
...
const var grs4 = Synth.getEffect("gran");
...
const var mixpahe = Content.getComponent("mixpahe");


inline function onmixpaheControl(component, value)
{
	mix.showControl(1-value); 
	mix.showControl(value);
};

Content.getComponent("mixpahe").setControlCallback(onmixpaheControl);
